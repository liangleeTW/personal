...
#let template = tufted.tufted-web.with(
  ...
  footer-elements: (
    "© 2026 Liang Lee",
    [Modified by #link("https://github.com/Yousa-Mirage/Tufted-Blog-Template")[Tufted-Blog-Template]],
  ),
)
